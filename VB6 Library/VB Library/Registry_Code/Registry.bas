...
'declarations for FloatWindow sub
...
Function APIConnectOtherRegistry(ByVal lngRootKey As Long, ByVal strMachineName As String, ByRef strGiveMessage As String) As Integer
'MRM Jan 96
...
Dim lngAPIResult As Long
    ...
    strGiveMessage = "APIConnectOtherRegistry: " & vbCrLf & " Machine is: " & strMachineName
    
    CheckForAPIError lngWasThereAnError, strGiveMessage
...
APIConnectOtherRegistry_Errorhandler:
    ...
    MsgBox "Error #" & Err & " in APIConnectOtherRegistry:" & Error, vbInformation, "Registry Example Project"
    Exit Function
...
Dim Result As Long
    ...
    On Error GoTo FloatWindow_ErrorHandler
...
Exit Sub
FloatWindow_ErrorHandler:
    Exit Sub

End Sub
Function APICreateKey(ByVal lngRootKey As Long, ByVal strFullKeyName As String, ByRef strGiveMessage As String) As Integer
'MRM Jan 96
'lngHandleToUse is set by this routine, and it's Module-level so all the API calls can use it
...
Dim lngAPIResult As Long
    ...
    'MsgBox ">" & lngRootKey & " >" & strFullKeyName & "  >" & strGiveMessage, , ""
    ...
    strGiveMessage = "APICreateKey:" & vbCrLf & " Key is:" & strFullKeyName
    CheckForAPIError lngWasThereAnError, strGiveMessage
...
APICreateKey_Errorhandler:
    APICreateKey = False
    MsgBox "Error #" & Err & " in APICreateKey:" & Error, vbInformation, "Registry Example Project"
    Exit Function


End Function

Function APIOpenKey(ByVal lngRootKey As Long, ByVal strFullKeyName As String, ByRef strGiveMessage As String) As Integer
'MRM Jan 96
'lngHandleToUse is set by this routine, and it's Module-level so all the API calls can use it
...
APIOpenKey_Errorhandler:
    APIOpenKey = False
    MsgBox "Error #" & Err & " in APIOpenKey:" & Error, vbInformation, "Registry Example Project"
    Exit Function


End Function

Function APISetKey(ByVal strMyValueName As String, ByVal lngDataType As Long, ByVal strMyValue As String, ByVal lngLength As Long, ByRef strGiveMessage As String) As Integer
'MRM Jan 96
'lngHandleToUse is set by this routine, and it's Module-level so all the API calls can use it
...
Dim lngWasThereAnError As Long
    ...
    strGiveMessage = "APISetKey: Value='" & strMyValue & "'"
    CheckForAPIError lngWasThereAnError, strGiveMessage
...
APISetKey_Errorhandler:
    APISetKey = False
    MsgBox "Error #" & Err & " in APISetKey:" & Error, vbInformation, "Registry Example Project"
    Exit Function

End Function

Function APIQueryKey(ByVal strMyValueName As String, ByRef strMyValue As String, ByRef strGiveMessage As String) As Integer
'MRM Jan 96
'lngHandleToUse is set by this routine, and it's Module-level so all the API calls can use it
...
Dim lngMyType As Long
    ...
    strGiveMessage = "APIQueryKey: " & vbCrLf & "Key: " & strMyValueName & vbCrLf & "Return Value: '" & strMyValue & "'"
    CheckForAPIError lngWasThereAnError, strGiveMessage
...
APIQueryKey_Errorhandler:
    APIQueryKey = False
    MsgBox "Error #" & Err & " in APIQueryKey:" & Error, vbInformation, "Registry Example Project"
    Exit Function

End Function
Function APIDeleteKey(ByVal strMyValueName As String, ByRef strGiveMessage As String) As Integer
'MRM Jan 96
'lngHandleToUse is set by this routine, and it's Module-level so all the API calls can use it
...
APIDeleteKey_Errorhandler:
    APIDeleteKey = False
    MsgBox "Error #" & Err & " in APIDeleteKey:" & Error, vbInformation, "Registry Example Project"
    Exit Function

End Function
Function APICloseKey(ByRef strGiveMessage As String) As Integer
'MRM Jan 96
'lngHandleToUse is set by this routine, and it's Module-level so all the API calls can use it
...
APICloseKey_Errorhandler:
    APICloseKey = False
    MsgBox "Error #" & Err & " in APICloseKey:" & Error, vbInformation, "Registry Example Project"
    Exit Function

End Function
Sub CheckForAPIError(ByVal lngAPIErrorCode As Long, ByRef strCheckErrorMessage As String)
'MRM jan 96
'Note that  this list is NOT exaustive, and is compiled from the list of constants in gen.decs
...
CheckForAPIError_Errorhandler:
    MsgBox "Error #" & Err & " in CheckForAPIError:" & Error, vbInformation, "Registry Example Project"
    Exit Sub
...
Function WrappedDeleteSetting(ByVal strAppName As String, ByVal strSectionName As String, ByRef strGiveMessage As String, Optional ByVal strKeyName As Variant) As Integer
'MRM Jan 96

    On Error GoTo WrappedDeleteSetting_Errorhandler
    WrappedDeleteSetting = True
    
    If IsMissing(strKeyName) Then
        DeleteSetting appname:=strAppName, section:=strSectionName
        strGiveMessage = "Deleted Section '" & strSectionName & "' and Sub-Keys From Registry OK."
    Else
        DeleteSetting appname:=strAppName, section:=strSectionName, Key:=strKeyName
        strGiveMessage = "Deleted Key '" & strKeyName & "' From Registry OK."
    End If
    
    Exit Function

WrappedDeleteSetting_Errorhandler:
    WrappedDeleteSetting = False
    MsgBox "Error #" & Err & " in WrappedDeleteSetting:" & Error, vbInformation, "Registry Example Project"
    Exit Function

End Function
Function WrappedSaveSetting(ByVal strAppName As String, ByVal strSectionName As String, ByVal strKeyName As String, ByVal strSetting As String, ByRef strGiveMessage As String) As Integer
'MRM Jan 96

Dim strResult As String

    On Error GoTo WrappedSaveSetting_Errorhandler
    WrappedSaveSetting = True
    ...
    If strSetting = strResult Then
        strGiveMessage = "Data '" & strSetting & "' Saved To Registry OK."
    Else
        strGiveMessage = "Data '" & strSetting & "' Failed To Saved To Registry."
    End If

    Exit Function

WrappedSaveSetting_Errorhandler:
    WrappedSaveSetting = False
    MsgBox "Error #" & Err & " in WrappedSaveSetting:" & Error, vbInformation, "Registry Example Project"
    Exit Function

End Function
Function WrappedGetSetting(ByVal strAppName As String, ByVal strSectionName As String, ByVal strKeyName As String, ByRef strGiveMessage As String, Optional ByVal strDefault As Variant) As Integer
'MRM Jan 96

Dim strResult As String

    On Error GoTo WrappedGetSetting_Errorhandler
    WrappedGetSetting = True
    ...
    If strResult <> strDefault Then
        ...
        strGiveMessage = "Got Data From Registry OK: >" & strResult & "<"
    Else
        'save default into the registry
        SaveSetting appname:=strAppName, section:=strSectionName, Key:=strKeyName, Setting:=strDefault
        strGiveMessage = "Got Data From Registry Failed: Saved New Default To Registry: >" & strDefault & "<"
    End If
    
    
    Exit Function

WrappedGetSetting_Errorhandler:
    WrappedGetSetting = False
    MsgBox "Error #" & Err & " in WrappedGetSetting:" & Error, vbInformation, "Registry Example Project"
    Exit Function
