...
'Sub Declares
    ...
    End If
End Sub
Public Function DelayedErrorFunction() As Boolean
'Created by Robin G Brown, INSERT_DATE
...
End Function
Public Sub mnuDelayedError_Click()
'Created by Robin G Brown, INSERT_DATE
'DESCRIPTION_OF_MENU_FUNCTIONALITY_HERE
    'Error Trap
    On Error Resume Next
    'CODE_HERE
End Sub
...
ImmediateErrorSub_ErrorHandler:
    ...
    Exit Sub
End Sub
Public Function ImmediateErrorFunction() As Boolean
'Created by Robin G Brown, INSERT_DATE
'DESCRIPTION_OF_FUNCTIONALITY_HERE
'Function Declares
